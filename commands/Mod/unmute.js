...
module.exports = {
    ...
    callback: (message, args) => {
        ...
        member.roles.remove('892636231815553065') // Removes Mute Role to User
        if(!member.roles.cache.has('892636231815553065')) return message.reply('User Is Already Unmuted.') // If User Is Already Unmuted.
