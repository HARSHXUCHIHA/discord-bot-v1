...
module.exports = (client) => {
    client.on('guildMemberAdd', async member => {
        ...
        const welcome = '891934632461893652' // Welcome Channel
        const rules = '902069167262425118' // Rules Channel
...
Please Check <#${rules}>
        ...
        member.roles.add('891934988654743582') // Add Role To User When Joins

    })


    const leavechannelId = '891934632461893652' //Channel You Want to Send The Leave Message
